      ...
      <div className="grow flex flex-col justify-center">
        <div className="max-w-screen-md space-y-9 -mt-24">
          <div className="space-y-5">
            <h1 className="text-5xl font-bold capitalize text-onLight dark:text-onLight">Wasim Al-Madfaa</h1>
            <p className="text-sm text-onLight dark:text-onLight text-start">
